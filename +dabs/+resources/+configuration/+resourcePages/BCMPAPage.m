classdef BCMPAPage < dabs.resources.configuration.ResourcePage
    properties
        pmhCOM
        pmAxis
        pmhAIFeedback
    ...
    methods
        function obj = BCMPAPage(hResource,hParent)
        ...
        function makePanel(obj,hParent)
            ...
            hTab = uitab('Parent',hTabGroup,'Title','Basic');
                most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [30 25 120 20],'Tag','txhMotor','String','COM Port:','HorizontalAlignment','right');
                obj.pmhCOM = most.gui.uicontrol('Parent',hTab,'Style','popupmenu','String',{''},'RelPosition', [160 22 120 20],'Tag','pmhCOM');
