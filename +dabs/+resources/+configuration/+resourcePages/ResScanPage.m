    ...
    methods
        ...
        function makePanel(obj,hParent)
            ...
            hTab = uitab('Parent',hTabGroup,'Title','Triggers');
                most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [10 105 160 20],'Tag','txBeamClock','String','Beam-Modified Line Clock','HorizontalAlignment','right');
                most.gui.uicontrol('Parent',hTab,'Style','edit','RelPosition', [180 102 160 20],'Tag','etBeamModifiedLineClock','String',obj.hResource.hTrig.beamModifiedLineClockOut,'Enable','off');

                most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [10 135 160 20],'Tag','txFrameClock','String','Frame Clock','HorizontalAlignment','right');
                most.gui.uicontrol('Parent',hTab,'Style','edit','RelPosition', [180 132 160 20],'Tag','etFrameClock','String',obj.hResource.hTrig.frameClockOut,'Enable','off');

                most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [10 165 160 20],'Tag','txAcquisitionClock','String','Acquisition Clock','HorizontalAlignment','right');
                most.gui.uicontrol('Parent',hTab,'Style','edit','RelPosition', [180 162 160 20],'Tag','etAcquisitionClock','String',obj.hResource.hTrig.acqTriggerOut,'Enable','off');
        end
