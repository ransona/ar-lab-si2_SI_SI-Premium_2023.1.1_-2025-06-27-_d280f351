classdef vDAQ_Config < dabs.resources.configuration.ResourcePage
    ...
    methods
        ...
        function makePanel(obj,hParent)
            ...
            obj.txRestartScanImage = most.gui.uicontrol('Parent',hParent,'Style','text','RelPosition', [-1 257 379 20],'Tag','txRestartScanImage','String','Please restart ScanImage for bitfile changes to be applied','BackgroundColor',[0.7 0.7 0]);
            obj.txRestartScanImage.Visible = false;
        end
        ...
        function apply(obj)
            ...
            bitfileNameChanged = ~strcmp(obj.hResource.bitfileName,obj.pmBitfile.string);
            obj.txRestartScanImage.Visible = bitfileNameChanged;
