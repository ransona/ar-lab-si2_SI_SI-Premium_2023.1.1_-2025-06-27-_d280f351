classdef DMC4040page < dabs.resources.configuration.ResourcePage
    properties
        pmhCOM
        txBaudRate
        pmBaudRate
    ...
    methods
        function obj = DMC4040page(hResource,hParent)
        ...
        function makePanel(obj,hParent)
            ...
            most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [24 30 120 20],'Tag','txInit','String','Init Cmd','HorizontalAlignment','right');
            obj.etInitCmd  = most.gui.uicontrol('Parent',hTab,'Style','edit','String',{''},'RelPosition', [150 27 120 20],'Tag','etInit');
            
            most.gui.uicontrol('Parent',hTab,'Style','text','RelPosition', [24 55 120 20],'Tag','txDeinit','String','Deinit Cmd','HorizontalAlignment','right');
            obj.etDeinitCmd = most.gui.uicontrol('Parent',hTab,'Style','edit','String',{''},'RelPosition', [150 52 120 20],'Tag','etDeinit');
        ...
        function redraw(obj)            
            ...
            if obj.isBaudRateSettable
                if isprop(obj.hResource,'AVAILABLE_BAUD_RATES')
                    obj.pmBaudRate.String = arrayfun(@(v)num2str(v),obj.hResource.AVAILABLE_BAUD_RATES,'UniformOutput',false);
                else
            ...
            obj.etInitCmd.String = obj.hResource.initCmd;
            obj.etDeinitCmd.String = obj.hResource.deinitCmd;
        end
        
        function apply(obj)
            obj.hResource.deinit();
            most.idioms.safeSetProp(obj.hResource,'hCOM',obj.pmhCOM.pmValue);
            most.idioms.safeSetProp(obj.hResource,'initCmd',obj.etInitCmd.String);
            most.idioms.safeSetProp(obj.hResource,'deinitCmd',obj.etDeinitCmd.String);
