classdef Widget < handle
    ...
    methods
        function obj = Widget(hResource,hParent)
                ...
                obj.hPanelOutline = uipanel('parent',obj.hFlow,'BorderWidth',2,'BorderType','line');
                    topPanelFlow = most.gui.uiflowcontainer('Parent',obj.hPanelOutline,'FlowDirection','TopDown','margin',0.001);
                        obj.hTitleFlow = most.gui.uiflowcontainer('Parent',topPanelFlow,'FlowDirection','LeftToRight','margin',1,'HeightLimits',[20 20]);
                            ...
                            obj.hTxtMinimize = most.gui.uicontrol('Parent',obj.hTitleFlow,'Style','text','Enable','inactive','String',most.constants.Unicode.black_up_pointing_triangle,'WidthLimits',[12 12],'ButtonDownFcn',@(varargin)toggleMinimize(true),'FontSize',8,'FontWeight','normal','ForegroundColor',textColor);
            ...
            obj.toggleMinimize = @(relayout)toggleMinimize(relayout);
            
            %%% Nested function
            function toggleMinimize(relayout)
                switch widgetFlow.Visible
                    case 'on'
                        ...
                        obj.hResource.minimizeOnStart = true;
                    case 'off'
                        ...
                        obj.hResource.minimizeOnStart = false;
                end
                
                if dabs.resources.widget.WidgetBar.isInstantiated && relayout
