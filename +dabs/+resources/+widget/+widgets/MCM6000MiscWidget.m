classdef MCM6000MiscWidget < dabs.resources.widget.Widget
    ...
    methods
        function obj = MCM6000MiscWidget(hResource,hParent)
            ...
            obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hResource.hMCM6000,'mirrorPosition1Name','PostSet',@(varargin)obj.renameButtons);
            obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hResource.hMCM6000,'mirrorPosition2Name','PostSet',@(varargin)obj.renameButtons);
        ...
        function makePanel(obj,hParent)            
            hFlow = most.gui.uiflowcontainer('Parent',hParent,'FlowDirection','TopDown','Margin',1e-3);
                ...
                hButtonFlow = most.gui.uiflowcontainer('Parent',hFlow,'FlowDirection','LeftToRight','Margin',1e-3, 'HeightLimits', [20 20]);
                    ...
                    if isempty(obj.hResource.hMCM6000.mirrorPosition1Name)
                        hButton.String = 'Position 1';
                    else
                        hButton.String = obj.hResource.hMCM6000.mirrorPosition1Name;
                    end
                    ...
                    if isempty(obj.hResource.hMCM6000.mirrorPosition2Name)
                        hButton.String = 'Position 2';
                    else
                        hButton.String = obj.hResource.hMCM6000.mirrorPosition2Name;
                    end
...
%                 return;
            ...
            if isempty(obj.hResource.hMCM6000.shutterSlot)
                obj.hPatchShutter.FaceColor = most.constants.Colors.white;
            else
                obj.hPatchShutter.FaceColor = most.constants.Colors.darkGray;
            end
            ...
            if isempty(obj.hResource.hMCM6000.mirrorSlot)
                obj.pbPosition1.Enable = 'off';
                obj.pbPosition2.Enable = 'off';
        ...
        function renameButtons(obj)
            obj.pbPosition1.String = obj.hResource.hMCM6000.mirrorPosition1Name;
            obj.pbPosition2.String = obj.hResource.hMCM6000.mirrorPosition2Name;
        end
