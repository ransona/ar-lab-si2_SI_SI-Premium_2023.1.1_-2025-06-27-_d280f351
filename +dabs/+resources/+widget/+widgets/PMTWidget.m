classdef PMTWidget < dabs.resources.widget.Widget
    ...
    methods
        ...
        function makeBackground(obj,hParent)
            ...
            [cdata,alpha] = readIm('PMT_on.PNG',most.idioms.wavelengthToRGB(obj.hResource.wavelength_nm));
        ...
        function redraw(obj)
            ...
            elseif obj.hResource.powerOn
                ...
                rgb = most.idioms.wavelengthToRGB(obj.hResource.wavelength_nm).* 0.75;
                obj.hSurfPmtOn.CData(:,:,1) = rgb(1) * 255;
                obj.hSurfPmtOn.CData(:,:,2) = rgb(2) * 255;
                obj.hSurfPmtOn.CData(:,:,3) = rgb(3) * 255;
        ...
        function configurePmtSettings(obj)
            ...
            hWidgetBar = obj.hResourceStore.showWidgetBar();
            hFig = hWidgetBar.hFig;
            
            if ~strcmpi(hFig.SelectionType,'open')
                queryPMTSettings();
            else
                clicks = clicks + 1;
                if clicks < 2
                    ...
                    %No-op. Don't queryPMTSettings for the number of clicks issued
                end
            end
            
            %Nested Function
            function queryPMTSettings()
                opts = struct;
