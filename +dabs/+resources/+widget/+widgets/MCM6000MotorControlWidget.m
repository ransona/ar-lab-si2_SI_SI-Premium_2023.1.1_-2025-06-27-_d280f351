classdef MCM6000MotorControlWidget < dabs.resources.widget.Widget
    ...
    methods
       ...
       function toggleEnable(obj, varargin)
           ...
           switch txt.Tag
               case 'hAx1'
                   obj.hResource.enableAxis('x', ~obj.hResource.axesEnabled(1));
               case 'hAx2'
                   obj.hResource.enableAxis('y', ~obj.hResource.axesEnabled(2));
               case 'hAx3'
                   obj.hResource.enableAxis('z', ~obj.hResource.axesEnabled(3));
               case 'hAx4'
                   obj.hResource.enableAxis('r', ~obj.hResource.axesEnabled(4));
           end
