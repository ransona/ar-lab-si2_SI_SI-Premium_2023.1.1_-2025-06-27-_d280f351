classdef FastZWidget < dabs.resources.widget.Widget
    ...
    methods
        function makePanel(obj,hParent)
            ...
            obj.hPatchObjective = patch('Parent',obj.hAx,'LineStyle','none','FaceColor',most.constants.Colors.darkGray,'ButtonDownFcn',@obj.refillDiscreteZs);
        ...
        function refillDiscreteZs(obj,varargin)
            if isa(obj.hResource,'dabs.thorlabs.LiquidCrystalFastZ')
                obj.hResource.setSlices();
            end
        end
    end
end
