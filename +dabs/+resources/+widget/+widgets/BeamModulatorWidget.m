classdef BeamModulatorWidget < dabs.resources.widget.Widget
    ...
    methods
        function obj = BeamModulatorWidget(hResource,hParent)
            ...
            obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hResource,'powerFraction2PowerWattLut','PostSet',@(varargin)obj.redraw);
            ...
            obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hResource,'powerFraction2PowerWattLut','PostSet',@(varargin)obj.redrawLut);
    ...
    methods
        ...
        function redraw(obj)
            ...
            if unknownFraction
                ...
                power_W = obj.hResource.convertPowerFraction2PowerWatt(fraction);
            end
        ...
        function click(obj)
            ...
            if ~strcmpi(hFig.SelectionType,'normal') && ~strcmpi(hFig.SelectionType,'open')
                % right click, shift click, ctrl click,
                % middle click, combined left and right click.
                obj.queryFraction();
            else
                % left click. Double click of other mouse buttons don't
                % call this.
                obj.startDrag();
            end
        end
