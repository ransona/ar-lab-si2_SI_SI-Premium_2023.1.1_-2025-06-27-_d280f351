classdef MCM6000VenetoMotorControlWidget < dabs.resources.widget.Widget
    ...
    methods
        function obj = MCM6000VenetoMotorControlWidget(hResource,hParent)
            ...
            if isa(obj.hResource, 'dabs.thorlabs.MCM6000_2_Async')
                ...
                obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hResource,'zAxisEnabled', 'PostSet',@(varargin)obj.redraw);
       ...
       function redraw(obj)
           ...
           iAxes = 1:numel(pos);
              ...
              % isMoving - Blue
              moving = obj.hResource.zAxisMoving;
              
              % isLimit - Orange
              limsActive = obj.hResource.anyAxesAtLimit;
              
              % isDisabled - Gray
              enabled = obj.hResource.zAxisEnabled;
       ...
       function redrawButtons(obj)
           if isempty(obj.hResource.errorMsg)
               most.gui.setComponentsBackgroundColor(obj.hReinitButton,'background');
               obj.hReinitButton.String = 'Deinit';
           else
               most.gui.setComponentsBackgroundColor(obj.hReinitButton,'red');
               obj.hReinitButton.String = 'Reinit';
           end
           
           if obj.hResource.isHomed
               most.gui.setComponentsBackgroundColor(obj.hHomeButton,'background');
           else
               most.gui.setComponentsBackgroundColor(obj.hHomeButton,'yellow');
           end
       end
       
       function redrawToggleJoystickButton(obj)
           if obj.hResource.enableJoystick %Indicate whether Joystick is enabled
               most.gui.setComponentsBackgroundColor(obj.hPbToggleJoystick,'green');
               obj.hPbToggleJoystick.String = 'Joystick enabled';
           else
               most.gui.setComponentsBackgroundColor(obj.hPbToggleJoystick,'background');
       ...
       function toggleEnable(obj, varargin)
           obj.hResource.enableAxis('z', ~obj.hResource.zAxisEnabled);
       ...
       function startHoming(obj)
           ...
           h = most.gui.nonBlockingDialog('Homing move',msg ...
               ,{{'OK',@(varargin)executeWithWatchMousePointer(@homingFunc)}, {'Cancel',@false}}, 'r' ...
           ...
           function homingFunc()
               try
                   ...
                   most.gui.setComponentsBackgroundColor(obj.hHomeButton,'blue');
                   drawnow();
       ...
       function reinit(obj,src,evt)
           ...
           function reinitFunc()
               if isempty(obj.hResource.errorMsg)
                   ...
                   if most.idioms.isValidObj(obj) && ~isempty(obj.hResource.errorMsg)
