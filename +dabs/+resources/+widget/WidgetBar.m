        ...
        function obj = WidgetBar()
            if ~obj.initialized
                ...
                obj.hFig = most.idioms.figure( ...
                    'CloseRequestFcn', @(varargin)obj.closeRequest() ...
                    ,'Name','Widget Bar' ...
                    ,'Tag','WidgetBar' ...
                    ,'Resize','off');
        ...
        function redrawProtected(obj)
            ...
            function makeWidgets()
                ...
                for idx = 1:numel(hResources)
                    if ~logical(hResources{idx}.widgetVisibility) || isprop(hResources{idx}, 'skipWidget') && (isempty(hResources{idx}.skipWidget) || logical(hResources{idx}.skipWidget))
                        continue;
                    end
