classdef LinearScanner < dabs.resources.Device
    ...
    methods        
        ...
        function val = position2Volts(obj,val,includeOffset)
            if nargin < 3 || isempty(includeOffset)
               includeOffset = true; 
            end
            
            validateattributes(includeOffset,{'logical'},{'scalar'});
            
            val = obj.lookUpPosition(val);
            val = val .* obj.voltsPerDistance + includeOffset*obj.distanceVoltsOffset;
        end
        ...
        function pointOffsetPosition(obj,position)
            ...
            if obj.offsetSecondaryTask
                ...
                usePortOffset = false;
                volt = obj.position2Volts(position,usePortOffset);
        ...
        function calibrateFeedback(obj,preventTrip,hWb)
            ...
            function plotCalibrationCurve()
                hFig = most.idioms.figure('Name','Scanner Calibration');
    ...
    methods
        ...
        function [optimizedWaveform,err] = optimizeWaveformIteratively(obj, desiredWaveform, sampleRateHz, cache) % Perhaps call reCache reOptimize instead? Better clarity maybe. 
            ...
            hFig = most.idioms.figure(...
                'units','pixels' ...
                ,'position',most.gui.centeredScreenPos([1200 900]) ...
                ,'Toolbar', 'figure' ...
                ,'Name',sprintf('%s waveform optimization',obj.name) ...
