    ...
    methods
        function obj = LinearScannerCalibrator(hLinearScanner)
            ...
            obj.hFig = most.idioms.figure( ...
                ...
                ,'Name',figName);
            obj.hFig.Position(3) = obj.hFig.Position(3)*1.3;
            ...
            hLutTable = most.gui.LutTable(hTablePanel,obj.hLinearScanner,'positionLUT');
            hLutTable.changeCallback = @obj.applyNewLut;
