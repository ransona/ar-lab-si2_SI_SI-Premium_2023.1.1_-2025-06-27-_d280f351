classdef DualPath_BScopeRedbox < dabs.resources.MicroscopeSystem    
    ...
    methods
        function reinit(obj)
            ...
            assert(~isa(obj.hVdaq,'dabs.resources.daqs.vDAQR0'),'Cannot configure this microscope for use with a Revision 0 vDAQ.');
            ...
            function hShutter = makeShutter(shutterName,doInd)
                try
                    ...
                    hShutter = dabs.resources.Resource.empty(1,0);
            ...
            function hResonantScanner = makeResonantScanner(resName,aoInd)
                try
                    ...
                    hResonantScanner = dabs.resources.Resource.empty(1,0);
                    most.ErrorHandler.logAndReportError(ME);
                end
            end
            ...
            function hGalvo = makeGalvo(galvoName,mult,ao,ai)
                try
                    ...
                    hGalvo = dabs.resources.Resource.empty(1,0);
                    most.ErrorHandler.logAndReportError(ME);
                end
            end
            ...
            function hPockels = makePockels(pockelsName,ao,ai)
                try
                    ...
                    hPockels = dabs.resources.Resource.empty(1,0);
                    most.ErrorHandler.logAndReportError(ME);
                end
            end
            ...
            function hPiezo = makePiezo(piezoName,ao,ai)
                try
                    ...
                    hPiezo = dabs.resources.Resource.empty(1,0);
                    most.ErrorHandler.logAndReportError(ME);
                end
            end
            ...
            function hScan = makeStimScanner(hGx, hGy, hS, hP, hZ)
                try
                    ...
                    hScan = dabs.resources.Resource.empty(1,0);
                    most.ErrorHandler.logAndReportError(ME);
                end
            end
        end
