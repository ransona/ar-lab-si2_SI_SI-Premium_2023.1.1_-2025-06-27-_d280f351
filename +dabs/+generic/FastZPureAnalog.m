classdef FastZPureAnalog < dabs.resources.devices.FastZAnalog & most.HasMachineDataFile & dabs.resources.configuration.HasConfigPage
    ...
    methods        
        ...
        function success = loadMdf(obj)
            ...
            success = success & obj.safeSetPropFromMdf('positionInterpolationAlgorithm', 'positionInterpolationAlgorithm');
        ...
        function saveMdf(obj)
            ...
            obj.safeWriteVarToHeading('positionInterpolationAlgorithm', obj.positionInterpolationAlgorithm);
...
s = [...
    ...
    most.HasMachineDataFile.makeEntry('positionInterpolationAlgorithm','default','Algorithm used for interpolating fastZ movement at volume flyback.')...
