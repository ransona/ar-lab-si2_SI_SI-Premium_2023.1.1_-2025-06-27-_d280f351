...
function mnu_View_Channels_Callback(hObject, eventdata, handles)
handles.hController.showGUI('channelControlsV4');
...
function mnu_View_TileView(hObject, eventdata, handles)
handles.hController.hTileView.raise();
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.showGUI('PhotostimControls');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.hWaveformControls.raise();
