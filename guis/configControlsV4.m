...
% Last Modified by GUIDE v2.5 09-Jan-2021 18:53:19
...
% hObject    handle to cbUniformSampling (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.updateModel(hObject,eventdata,handles);
if logical(hObject.Value)
    handles.etPixelBinFactor.Enable = 'on';
else
    handles.etPixelBinFactor.Enable = 'off';
end

% Hint: get(hObject,'Value') returns toggle state of cbUniformSampling
