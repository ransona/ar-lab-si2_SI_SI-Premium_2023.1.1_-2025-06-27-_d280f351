...
% Last Modified by GUIDE v2.5 06-Jan-2022 17:05:14
...
% --- Executes on button press in pbRefreshOutputChannelsList.
function pbRefreshOutputChannelsList_Callback(hObject, eventdata, handles)
% hObject    handle to pbRefreshOutputChannelsList (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.hController.refreshOutputChannelsList();
