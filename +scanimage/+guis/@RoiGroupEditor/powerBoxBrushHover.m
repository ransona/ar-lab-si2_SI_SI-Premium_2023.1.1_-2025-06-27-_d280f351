function powerBoxBrushHover(obj, varargin)
    try
        mouseLocation = obj.h2DMainViewAxes.CurrentPoint(1,1:2);
        obj.selectedPowerBoxDisplay.updateBrushPreview(mouseLocation);
    catch
