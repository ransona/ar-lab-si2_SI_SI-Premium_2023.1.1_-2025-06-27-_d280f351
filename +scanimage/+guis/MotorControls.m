classdef  MotorControls < most.Gui    
    ...
    methods (Access = protected)
        function initGui(obj)
            ...
            function setupListeners()
                ...
                obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hModel.hMotors,'azimuth','PostSet',@obj.updateTiltColor);
                obj.hListeners(end+1) = most.ErrorHandler.addCatchingListener(obj.hModel.hMotors,'elevation','PostSet',@(varargin)obj.updateTiltColor());
            end
    ...
    methods
        ...
        function updateTiltColor(obj,varargin)
            if obj.isGuiLoaded
                if obj.hModel.hMotors.azimuth || obj.hModel.hMotors.elevation
                    obj.pbTiltMotors.hCtl.BackgroundColor = most.constants.Colors.lightGreen;
                else
                    obj.pbTiltMotors.hCtl.BackgroundColor = most.constants.Colors.lightGray;
                end
            end
        end
