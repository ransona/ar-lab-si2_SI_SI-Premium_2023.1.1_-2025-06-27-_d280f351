classdef RenderTool < handle
        ...
        function init(obj)
            if ~most.idioms.isValidObj(obj.hFig)
                obj.hFig = most.idioms.figure( ...
                    ...
                    , 'units', 'pixels' ...
                    , 'position',[0 0 440 204] ...
                    ,'CloseRequestFcn',@obj.hideDialog ...
                    ,'visible','off' ...
                    ,'resize','off');
            ...
            if ~most.idioms.isValidObj(obj.hRenderFig)
                obj.hRenderFig = most.idioms.figure( ...
                    'name','Render Preview' ...
                    ,'units','pixels' ...
                    ,'Color','k'...
                    , 'position',[0 0 600 600] ...
                    ,'CloseRequestFcn',@obj.hideRenderFig ...
                    ,'visible','off' ...
                    ,'SizeChangedFcn',@obj.resizeRenderWindow);
    ...
    methods
        ...
        function configureCamera(obj,varargin)
            ...
            most.idioms.figure(obj.hRenderFig);
        end
