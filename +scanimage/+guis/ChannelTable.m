classdef ChannelTable < handle
    ...
    methods
        ...
        function virtChansChanged(obj,varargin)
            if isprop(obj.hSI.hScan2D, 'virtualChannelSettings') ...
                    && numel(obj.hSI.hScan2D.virtualChannelSettings) ~= obj.hSI.hChannels.channelsAvailable;
                channelCountUpdateOnly = true;
                obj.hSI.hChannels.registerChannels(channelCountUpdateOnly);
            end
            obj.updateFullData();
        end
