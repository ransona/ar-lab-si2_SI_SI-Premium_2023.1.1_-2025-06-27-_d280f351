...
vidriotechnologies.com:vidrio:vDAQ_MSADC:1.0\
...
proc create_hier_cell_dma_axi { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S11_AXI_1 [get_bd_intf_pins S10_AXI] [get_bd_intf_pins axi_crossbar_0/S10_AXI]
  connect_bd_intf_net -intf_net S12_AXI_1 [get_bd_intf_pins S11_AXI] [get_bd_intf_pins axi_crossbar_0/S11_AXI]
...
proc create_hier_cell_PCIE_AXI { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M08_AXI] [get_bd_intf_pins axi_interconnect_4/M08_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins M09_AXI] [get_bd_intf_pins axi_interconnect_4/M09_AXI]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins M10_AXI] [get_bd_intf_pins axi_interconnect_4/M10_AXI]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins M11_AXI] [get_bd_intf_pins axi_interconnect_4/M11_AXI]
  connect_bd_intf_net -intf_net DIGITAL_DMA_1 [get_bd_intf_pins DIGITAL_DMA] [get_bd_intf_pins dma_axi/S11_AXI]
  ...
  connect_bd_intf_net -intf_net S10_AXI_1 [get_bd_intf_pins S10_AXI] [get_bd_intf_pins dma_axi/S09_AXI]
  connect_bd_intf_net -intf_net S11_AXI_1 [get_bd_intf_pins S11_AXI] [get_bd_intf_pins dma_axi/S10_AXI]
...
proc create_root_design { parentCell } {
  ...
  set SI_AUX_FIFO_1 [ create_bd_intf_port -mode Slave -vlnv vidriotech.com:vidrio:variable_fifo_write_rtl:1.0 SI_AUX_FIFO_1 ]

  set SI_DATA_FIFO_0 [ create_bd_intf_port -mode Slave -vlnv vidriotech.com:vidrio:variable_fifo_write_rtl:1.0 SI_DATA_FIFO_0 ]

  set SI_DATA_FIFO_1 [ create_bd_intf_port -mode Slave -vlnv vidriotech.com:vidrio:variable_fifo_write_rtl:1.0 SI_DATA_FIFO_1 ]
  ...
  set msadcSampleClk [ create_bd_port -dir O -type clk msadcSampleClk ]
  ...
  # Create instance: SI_ACQ_FIFO_1, and set properties
  set SI_ACQ_FIFO_1 [ create_bd_cell -type ip -vlnv vidriotechnologies.com:vidrio:FIFO2MM_Transport:2.0 SI_ACQ_FIFO_1 ]
  set_property -dict [ list \
  ...
  # Create instance: SI_AUX_FIFO_1, and set properties
  set SI_AUX_FIFO_1 [ create_bd_cell -type ip -vlnv vidriotechnologies.com:vidrio:FIFO2MM_Transport:2.0 SI_AUX_FIFO_1 ]
  set_property -dict [ list \
   CONFIG.ACTUAL_DEPTH_CALC {1638} \
   CONFIG.AVOID_DB_WIDTH_CALC {11} \
   CONFIG.AXI_DATA_WIDTH {256} \
  ...
  connect_bd_intf_net -intf_net PCIE_AXI_M06_AXI [get_bd_intf_pins PCIE_AXI/M06_AXI] [get_bd_intf_pins SI_AUX_FIFO_0/SAXIL_CFG]
  connect_bd_intf_net -intf_net PCIE_AXI_M07_AXI [get_bd_intf_pins PCIE_AXI/M07_AXI] [get_bd_intf_pins SI_ACQ_FIFO_0/SAXIL_CFG]
  connect_bd_intf_net -intf_net PCIE_AXI_M08_AXI [get_bd_intf_pins PCIE_AXI/M08_AXI] [get_bd_intf_pins SI_SCOPE_FIFO/SAXIL_CFG]
  connect_bd_intf_net -intf_net PCIE_AXI_M09_AXI [get_bd_intf_pins PCIE_AXI/M09_AXI] [get_bd_intf_pins SI_AUX_FIFO_1/SAXIL_CFG]
  connect_bd_intf_net -intf_net PCIE_AXI_M10_AXI [get_bd_intf_pins PCIE_AXI/M10_AXI] [get_bd_intf_pins SI_ACQ_FIFO_1/SAXIL_CFG]
  connect_bd_intf_net -intf_net PCIE_AXI_M11_AXI [get_bd_intf_pins HSADC/SAXIL_CFG] [get_bd_intf_pins PCIE_AXI/M11_AXI]
  ...
  connect_bd_intf_net -intf_net SI_ACQ_FIFO_1_MAXI_DATA_OUT [get_bd_intf_pins PCIE_AXI/S11_AXI] [get_bd_intf_pins SI_ACQ_FIFO_1/MAXI_DATA]
  ...
  connect_bd_intf_net -intf_net SI_AUX_FIFO_1_1 [get_bd_intf_ports SI_AUX_FIFO_1] [get_bd_intf_pins SI_AUX_FIFO_1/FIFO_DATA_IN]
  connect_bd_intf_net -intf_net SI_AUX_FIFO_1_MAXI_DATA_OUT [get_bd_intf_pins PCIE_AXI/S05_AXI] [get_bd_intf_pins SI_AUX_FIFO_1/MAXI_DATA]
  ...
  connect_bd_intf_net -intf_net SI_DATA_FIFO_1_1 [get_bd_intf_ports SI_DATA_FIFO_1] [get_bd_intf_pins SI_ACQ_FIFO_1/FIFO_DATA_IN]
  ...
  connect_bd_intf_net -intf_net SI_SCOPE_FIFO_0_MAXI_DATA_OUT [get_bd_intf_pins PCIE_AXI/S10_AXI] [get_bd_intf_pins SI_SCOPE_FIFO/MAXI_DATA]
  ...
  connect_bd_net -net MSADC_sampleClk [get_bd_ports msadcSampleClk] [get_bd_pins MSADC/sampleClk]
  ...
  connect_bd_net -net axi_pcie3_0_axi_aclk [get_bd_ports pcie_aclk] [get_bd_pins DAQ/axiClk] [get_bd_pins HSADC/axiClk] [get_bd_pins PCIE_AXI/aclk] [get_bd_pins PCIE_SAXIL/ACLK] [get_bd_pins SI_ACQ_FIFO_0/axiClk] [get_bd_pins SI_ACQ_FIFO_1/axiClk] [get_bd_pins SI_AUX_FIFO_0/axiClk] [get_bd_pins SI_AUX_FIFO_1/axiClk] [get_bd_pins SI_SCOPE_FIFO/axiClk]
  connect_bd_net -net axi_pcie3_0_axi_aresetn [get_bd_ports pcie_aresetn] [get_bd_pins DAQ/axiResetN] [get_bd_pins HSADC/axiResetN] [get_bd_pins PCIE_AXI/aresetn] [get_bd_pins PCIE_SAXIL/ARESETN] [get_bd_pins SI_ACQ_FIFO_0/axiResetN] [get_bd_pins SI_ACQ_FIFO_1/axiResetN] [get_bd_pins SI_AUX_FIFO_0/axiResetN] [get_bd_pins SI_AUX_FIFO_1/axiResetN] [get_bd_pins SI_SCOPE_FIFO/axiResetN]
  connect_bd_net -net dataClk_1 [get_bd_ports dataClk] [get_bd_pins SI_ACQ_FIFO_0/inputClk] [get_bd_pins SI_ACQ_FIFO_1/inputClk] [get_bd_pins SI_AUX_FIFO_0/inputClk] [get_bd_pins SI_AUX_FIFO_1/inputClk] [get_bd_pins SI_SCOPE_FIFO/inputClk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x010000000000 -target_address_space [get_bd_addr_spaces SI_ACQ_FIFO_1/MAXI_DATA] [get_bd_addr_segs PCIE_AXI/vDAQ_PCIE_AXI_0/SAXI/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x010000000000 -target_address_space [get_bd_addr_spaces SI_AUX_FIFO_1/MAXI_DATA] [get_bd_addr_segs PCIE_AXI/vDAQ_PCIE_AXI_0/SAXI/reg0] -force
  ...
  assign_bd_address -offset 0x00460000 -range 0x00010000 -target_address_space [get_bd_addr_spaces PCIE_AXI/vDAQ_PCIE_AXI_0/MAXI] [get_bd_addr_segs MSADC/SAXIL_CFG/reg0] -force
  ...
  assign_bd_address -offset 0x00483000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIE_AXI/vDAQ_PCIE_AXI_0/MAXI] [get_bd_addr_segs SI_ACQ_FIFO_1/SAXIL_CFG/reg0] -force
  ...
  assign_bd_address -offset 0x00484000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIE_AXI/vDAQ_PCIE_AXI_0/MAXI] [get_bd_addr_segs SI_AUX_FIFO_1/SAXIL_CFG/reg0] -force
