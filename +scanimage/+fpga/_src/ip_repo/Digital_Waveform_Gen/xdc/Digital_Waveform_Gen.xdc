...
#set_false_path -from [get_pins generate_lutram_ranks[*].generate_lutram_cols[*].RAM32X1D_inst/DP/CLK] -through [get_pins generate_lutram_ranks[*].generate_lutram_cols[*].RAM32X1D_inst/DP/O]
