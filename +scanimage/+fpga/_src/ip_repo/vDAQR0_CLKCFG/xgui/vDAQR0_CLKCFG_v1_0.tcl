...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "USE_AXI_CFG_PORT" -parent ${Behavior}
...
proc update_PARAM_VALUE.USE_AXI_CFG_PORT { PARAM_VALUE.USE_AXI_CFG_PORT } {
	# Procedure called to update USE_AXI_CFG_PORT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.USE_AXI_CFG_PORT { PARAM_VALUE.USE_AXI_CFG_PORT } {
	# Procedure called to validate USE_AXI_CFG_PORT
	return true
}
...
proc update_MODELPARAM_VALUE.USE_AXI_CFG_PORT { MODELPARAM_VALUE.USE_AXI_CFG_PORT PARAM_VALUE.USE_AXI_CFG_PORT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.USE_AXI_CFG_PORT}] ${MODELPARAM_VALUE.USE_AXI_CFG_PORT}
}
