classdef Triggering < scanimage.interfaces.Class
    ...
    methods
        ...
        function applyTriggerConfig(obj)            
            ...
            obj.hFpgaAE.acqParamPeriodTriggerDebounce = min([round(dbt) maxPeriodTriggerDebounce]);
            ...
            obj.LRRLaserSyncIn = obj.hScan.LRRLaserSyncPort;
            ...
            laserTriggerDebounceWidth = 5;
            maxLaserTriggerDebounce = 2^laserTriggerDebounceWidth-1;
            obj.hFpgaAE.acqParamLaserClkDebounce = min([obj.hScan.laserTriggerDebounceTicks maxLaserTriggerDebounce]);
        end
    ...
    methods
        ...
        function set.LRRLaserSyncIn(obj,newTerminal)
            id = obj.hFpga.dioNameToId(newTerminal);
            obj.LRRLaserSyncIn = newTerminal;
            obj.hFpgaAE.acqParamLaserClkSyncChIdx = id;
        end
