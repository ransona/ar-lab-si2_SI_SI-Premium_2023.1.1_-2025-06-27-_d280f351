    ...
    methods
        ...
        function stripeToDisk(obj,stripeData)
            ...
            elseif obj.hLinScan.hSI.hStackManager.isSlowZ
                ...
                % acquisition or whether it is just the end of a slice
                if stripeData.endOfAcquisition && ~stripeData.endOfAcquisitionMode
                    % Check to see if last slice.
                    if obj.hLinScan.hSI.hStackManager.volumesDone >= obj.hLinScan.hSI.hStackManager.actualNumVolumes - 1 && ...
                            obj.hLinScan.hSI.hStackManager.slicesDone >= obj.hLinScan.hSI.hStackManager.actualNumSlices - 1
