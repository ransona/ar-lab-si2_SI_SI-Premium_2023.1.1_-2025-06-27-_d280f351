    ...
    methods
        ...
        function [path_FOV, seconds] = scanPathFOV(obj,scanfield,roi,actz,actzRelative,dzdt,zActuator,maxPtsPerSf)
            ...
            if isa(scanfield,'scanimage.mroi.scanfield.ImagingField')
                ...
                actzRelative = obj.scanners{1}.hParkPosition.transform(obj.hCSReference).points(3);
                ...
                if obj.hasBeams
                    ...
                    [powerFractions, pzAdjust, Lzs, interlaceDecimation, interlaceOffset] = getRoiBeamProps(...
            ...
            %%% Nested Function
            function [powerFractions, pzAdjust, Lzs, interlaceDecimation, interlaceOffset] = getRoiBeamProps(varargin)
                powerFractions = obj.beams.powerFraction;
                pzAdjust = false;
                Lzs = obj.beams.Lz;
                interlaceDecimation = obj.beams.interlaceDecimation;
                interlaceOffset= obj.beams.interlaceOffset;
            end
        end
