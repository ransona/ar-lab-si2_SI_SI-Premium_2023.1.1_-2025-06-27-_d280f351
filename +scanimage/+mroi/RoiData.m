classdef RoiData < handle & matlab.mixin.Copyable
    ...
    properties
        ...
        absStagePosition;              % 3 x 1 double array of stage position in absolute coordinates in microns (Added when adding an ROI for motion detection/correction reference).
    end
    ...
    methods
        ...
        function s = saveobj(obj)
            ...
            s.absStagePosition = obj.absStagePosition;
        end
    end
    ...
    methods (Static)
        function obj = loadobj(s)
            ...
            obj.absStagePosition = s.absStagePosition;
        end
    end
end
