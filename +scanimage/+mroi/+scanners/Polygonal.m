classdef Polygonal < handle
    ...
    methods(Static)
        function obj = default
            obj=scanimage.mroi.scanners.Polygonal(15,7910,false,0.7);
        end
    end

    methods
        function obj=Polygonal(hDevice,scannerPeriod,bidirectionalScan,fillFractionSpatial)
            obj.hDevice = hDevice;
            obj.scannerPeriod = scannerPeriod;
            obj.bidirectionalScan = false;
