        ...
        function path_FOV = interpolateTransits(obj,ss,path_FOV,tune,zWaveformType)
            ...
            switch zWaveformType
                ...
                case 'step'
                    % replace Infs
                    boundingpolygon = [];
                    algorithm = 'linearwithsettle';
                    rangeIdentifier = Inf;
                    path_FOV = scanimage.mroi.util.interpolateCircularNaNRanges( ...
                        path_FOV ...
                        , boundingpolygon ...
                        , algorithm ...
                        , rangeIdentifier);
                otherwise
                    %This can happen if hReserver is a stimulation scanner
            end
            ...
            path_FOV = scanimage.mroi.util.interpolateCircularNaNRanges( ...
                path_FOV ...
                , boundingpolygon ...
                , obj.positionInterpolationAlgorithm);
            ...
            % Voltages directly
            if any(path_FOV < allowedTravelRange(1)) ...
                    || any(path_FOV > allowedTravelRange(2))
                most.idioms.warn([ ...
                    'FastZ waveform exceeded actuator range. ' ...
