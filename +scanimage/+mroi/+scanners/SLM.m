classdef SLM < handle
    ...
    methods
        ...
        function [phi,efficiency,correctedWeights] = computeMultiPointPhaseMask(obj,hPts,weights)            
            ...
            if any(diffractionEfficiency < eps | diffractionEfficiency > 1)
                warnText = sprintf(['SLM Diffraction Efficiency interpolant produced unrealistic efficiencies for some or all points.\n'...
                    'Setting these points efficiencies to 1.']);
                most.idioms.warn(warnText);
                diffractionEfficiency(diffractionEfficiency < eps | diffractionEfficiency > 1) = 1;
            end
    ...
    methods
        ...
        function setCSDiffractionEfficiency(obj,hDiffractionEfficiency)
            validateattributes(hDiffractionEfficiency,{'scanimage.mroi.coordinates.CSLut','scanimage.mroi.coordinates.CSFunction'},{'scalar'});
            obj.hCSDiffractionEfficiency = hDiffractionEfficiency;
        end
