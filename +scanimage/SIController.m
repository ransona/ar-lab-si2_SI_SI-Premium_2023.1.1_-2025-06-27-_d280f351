    ...
    methods (Hidden)
        function obj = SIController(hModel,hWb)
            ...
            visibleGuis = {'mainControlsV4' 'configControlsV4' 'imageControlsV4'...
                'channelControlsV4' 'scanimage.guis.MotorControls' 'scanimage.guis.BeamControls' 'scanimage.guis.StackControls'};
            hiddenGuis = {'fastConfigurationV4' 'userFunctionControlsV4' 'triggerControlsV5' 'userSettingsV4'...
                'scanimage.guis.PhotostimControls' 'scanimage.guis.WaveformControls' 'powerBoxControlsV4'...
                ...
                'scanimage.guis.AlignmentControls' 'scanimage.guis.MotorsAlignmentControls' 'scanimage.guis.MotionDisplay'...
            ...
            if scc
                ...
                m.Callback = @(varargin)obj.hSignalConditioningControls.raise();
            end
        ...
        function initialize(obj,usr,hidegui)
            ...
            if isempty(usr) || ~obj.hModel.hConfigurationSaver.usrLoadUsr(usr)
                ...
                if ~hidegui
                    ...
                    cellfun(@(gui)obj.raiseGUI(obj.hGUIs.(regexp(gui,'[^\.]*$','match','once'))),obj.defaultGuis);
            ...
            obj.hModel.applicationOpen = true;
...
%             drawnow expose % otherwise the main gui is not always moved to the correct position
            ...
            most.gui.tetherGUIs(obj.hGUIs.mainControlsV4,obj.hGUIs.triggerControlsV5,'rightbottom',obj.WINDOW_BORDER_SPACING);
            ...
            most.gui.tetherGUIs(obj.hGUIs.BeamControls,obj.hGUIs.powerBoxControlsV4,'rightbottom',obj.WINDOW_BORDER_SPACING);
            ...
            most.gui.tetherGUIs(obj.hGUIs.StackControls,obj.hPhotostimControls.hFig,'rightbottom',obj.WINDOW_BORDER_SPACING);
            most.gui.tetherGUIs(obj.hGUIs.StackControls,obj.hAlignmentControls.hFig,'righttop',obj.WINDOW_BORDER_SPACING);
            
            % stack channel display figures
            initialPosition = [763 261];
            offset = 30;
            numFigs = length(obj.hModel.hDisplay.hFigs);
            for i = 1:numFigs
                figNum = i;
                if figNum == 1
                    most.gui.tetherGUIs(obj.hGUIs.StackControls,obj.hModel.hDisplay.hFigs(figNum),'bottomcenter',obj.WINDOW_BORDER_SPACING);
                else
                    offset_ = offset * (i-1);
...
%             end
        ...
        function refreshOutputChannelsList(obj)
            ...
            channelNames = {obj.hModel.hIntegrationRoiManager.hIntegrationRoiOutputChannels.name};
            if isempty(channelNames)
                set(obj.hGUIData.integrationRoiOutputChannelControlsV5.pmOutputChannel ...
                    , 'String', {''} ...
                    , 'Value', 1);
                return
            end
        ...
        function ziniCameras(obj)
            ...
            for idx=1:length(wrappers)
                ...
                uimenu('Parent',camRootMenu,'Label', cameraName,...
                    'Tag', cameraName, 'Callback', @(varargin)view.raise());
        ...
        function zcbkKeyPress(obj,~,evt)
            % Currently this handles keypresses for all old SI guis
            switch evt.Key
                ...
                case {'home'}
                    if any(contains(evt.Modifier,'shift'))
                        obj.ziniFigPositions();
                    end
                    obj.raiseAllGUIs;
        ...
        function ziniConfigControls(obj)
            ...
            for i = 1:numel(obj.hModel.hScanners)
                ...
                if isa(hScn, 'scanimage.components.scan2d.RggScan')
                    if strcmp(hScn.scannerType,'RGG')
                        imSystemList = [imSystemList; {sprintf('%s (Resonant)', scannerName); sprintf('%s (Linear)', scannerName)}];
                    elseif strcmp(hScn.scannerType, 'RG')
                        imSystemList = [imSystemList; {sprintf('%s (Resonant)', scannerName)}];
                    elseif strcmp(hScn.scannerType, 'GG')
                        imSystemList = [imSystemList; {sprintf('%s (Linear)', scannerName)}];
                    end
                    
                    hMotors = obj.hModel.hMotors.hMotorXYZ;
                    if hScn.hasResonantMirror && isequal(hMotors{1},hMotors{2}) && isa(hMotors{1},'dabs.zaber.ZaberMultiDevice') && hMotors{1}.supportsStreamScanning
                        imSystemList = [imSystemList; {sprintf('%s (Stage)', scannerName)}];
                    end
                else
    ...
    methods (Hidden)
        ...
        function showChannelDisplay(obj,channelIdx)
            ...
            most.idioms.figure(obj.hModel.hDisplay.hFigs(channelIdx));
        end
        ...
        function updateScanControls(obj,varargin)
            ...
            nonPolyCtls = [obj.hGUIData.mainControlsV4.stScanRotation obj.hGUIData.mainControlsV4.scanRotation obj.hGUIData.mainControlsV4.scanRotationSlider obj.hGUIData.mainControlsV4.zeroRotate...
                obj.hGUIData.mainControlsV4.stScanShiftFast obj.hGUIData.mainControlsV4.scanShiftFast...
                obj.hGUIData.mainControlsV4.zoomText obj.hGUIData.mainControlsV4.zoomtens obj.hGUIData.mainControlsV4.zoomtensslider obj.hGUIData.mainControlsV4.zoomones...
                obj.hGUIData.mainControlsV4.zoomonesslider obj.hGUIData.mainControlsV4.stScanAngleMultiplier obj.hGUIData.mainControlsV4.zoomfrac obj.hGUIData.mainControlsV4.zoomfracslider...
                obj.hGUIData.mainControlsV4.fullfield obj.hGUIData.mainControlsV4.left obj.hGUIData.mainControlsV4.right...
                obj.hGUIData.mainControlsV4.zero obj.hGUIData.mainControlsV4.ystep obj.hGUIData.mainControlsV4.xstep obj.hGUIData.mainControlsV4.text50 obj.hGUIData.configControlsV4.pmPixelsPerLine...
                obj.hGUIData.mainControlsV4.stScanAngleMultiplierFast obj.hGUIData.mainControlsV4.etScanAngleMultiplierFast...
                obj.hGUIData.mainControlsV4.tbToggleLinescan obj.hGUIData.configControlsV4.pbCalibrateLinePhase];
...
%                 set(obj.hGUIData.configControlsV4.pmScanRateVar, 'String', {'Pixel Dwell Time (ns)' 'Line Rate (Hz)' 'Line Period (us)' 'Sample Rate (MHz)'});
            ...
            if isprop(obj.hModel.hScanner, 'isPolygonalScanning') && obj.hModel.hScanner.isPolygonalScanning %&& ~isempty(pnlScanParams)
        ...
        function editImagingRoiGroup(obj,tfShow)
            if nargin < 2 || tfShow
                ...
                most.idioms.figure(obj.hRoiGroupEditor.hFig)
            end
    ...
    methods (Hidden)
        ...
        function changedScanMode(obj,~,~)
            ...
            %Mini2P considerations
            if hS2d.hasResonantMirror && isa(hS2d.hResonantScanner,'dabs.mirrorcle.ResonantAxis')
                obj.hAcqListeners = most.ErrorHandler.addCatchingListener(obj.hModel,'acqState','PostSet',@(varargin)setMini2PControls(varargin));
            else
...
%             obj.ziniPowerBoxControls();
            ...
            function setMini2PControls(varargin)
                nonLiveMini2PCtls = [obj.hGUIData.mainControlsV4.stScanRotation obj.hGUIData.mainControlsV4.scanRotation obj.hGUIData.mainControlsV4.scanRotationSlider obj.hGUIData.mainControlsV4.zeroRotate...
                    obj.hGUIData.mainControlsV4.stScanShiftFast obj.hGUIData.mainControlsV4.scanShiftFast obj.hGUIData.mainControlsV4.stScanShiftSlow obj.hGUIData.mainControlsV4.scanShiftSlow...
                    obj.hGUIData.mainControlsV4.zoomText obj.hGUIData.mainControlsV4.zoomtens obj.hGUIData.mainControlsV4.zoomtensslider obj.hGUIData.mainControlsV4.zoomones...
                    obj.hGUIData.mainControlsV4.zoomonesslider obj.hGUIData.mainControlsV4.stScanAngleMultiplier obj.hGUIData.mainControlsV4.zoomfrac obj.hGUIData.mainControlsV4.zoomfracslider...
                    obj.hGUIData.mainControlsV4.fullfield...
                    obj.hGUIData.mainControlsV4.zero obj.hGUIData.mainControlsV4.ystep obj.hGUIData.mainControlsV4.xstep obj.hGUIData.mainControlsV4.text50 obj.hGUIData.configControlsV4.pmPixelsPerLine...
                    obj.hGUIData.mainControlsV4.stScanAngleMultiplierFast obj.hGUIData.mainControlsV4.etScanAngleMultiplierFast...
                    obj.hGUIData.mainControlsV4.stScanAngleMultiplierSlow obj.hGUIData.mainControlsV4.etScanAngleMultiplierSlow...
                    obj.hGUIData.mainControlsV4.tbToggleLinescan];

                if strcmpi(obj.hModel.acqState,'idle') && ~obj.hModel.hRoiManager.mroiEnable
                    set(nonLiveMini2PCtls,'Enable','on');
                else
                    set(nonLiveMini2PCtls,'Enable','off');
                end
            end
        ...
        function changeImagingSystem(obj,hObject)
            ...
            newScannerString = sys{get(hObject,'Value')};
            
            % If switching to a different scanner, make sure the resonant
            % scanner is turned off.
            if ~strcmp(obj.hModel.imagingSystem, newScannerString)
                obj.hModel.hScan2D.keepResonantScannerOn = 0;
            end
            obj.hModel.imagingSystem = newScannerString;
            
            pbCalibrateLinePhase = findobj('Tag', 'pbCalibrateLinePhase');
            if obj.hModel.hScanner.isPolygonalScanning
                pbCalibrateLinePhase.Enable = 'off';
            else
                if obj.hModel.hScan2D.bidirectional
        ...
        function selectPowerBox(obj)
            if obj.pbIdx > numel(obj.hModel.hBeams.powerBoxes)
                hBeamComponent = obj.hModel.hBeams;
                hNewPowerBox = scanimage.components.beams.PowerBox();
                hNewPowerBox.powers = NaN(1, hBeamComponent.totalNumBeams);
                hBeamComponent.powerBoxes(obj.pbIdx) = hNewPowerBox;
                obj.ziniPowerBoxControls();
            else
                obj.changedPowerBoxes();
            end
...
%                 obj.hModel.hStackManager.framesPerSlice = 1;
        ...
        function tuneActuator(obj,varargin)
            ...
            if most.idioms.isValidObj(obj.hFastZTuneFig)
                ...
                pltResp = [];
                avg = 10;
                obj.hFastZTuneFig = most.idioms.figure( ...
                    'Name','FastZ Actuator Tuning' ...
                    ,'Color','White' ...
                    ,'ToolBar','figure' ...
                    ,'tag','FASTZTUNING');
            ...
            if ~isnan(val)
                ...
                if isempty(binFs)
                    ...
                    if isempty(validRates) || isempty(validFactors)
                        ...
                        obj.hModel.hScan2D.pixelBinFactor = unique(validFactors(find(validRates == max(validRates))));
