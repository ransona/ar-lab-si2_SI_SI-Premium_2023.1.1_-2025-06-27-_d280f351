classdef StripeData < handle & matlab.mixin.Copyable
    ...
    properties
        ...
        focalPoint;                 % scanimage.mroi.coordinates.Points object in absolute position coordinates for the focal point (added in hSI.zzzStripeAcquiredFcn).
        stackMode;                  % [char] vector describing which stack mode is used for acquisition
    end
