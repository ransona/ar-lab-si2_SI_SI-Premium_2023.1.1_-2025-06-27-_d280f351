classdef HasMachineDataFile < most.HasClassDataFile
    ...
    methods (Static)
        ...
        % NOTE: When using makeEntry with cell array "value", ensure
        %       that you wrap the enitre cell array in a single cell
        %       to make the value work with the struct constructor.
        %       It could be changed, but then new makeEntry syntax wont work 
        %       for older ScanImage versions in the case we want to provide
        %       a driver or something to a customer running an old version.
        % E.G.: {{}} for {},  {{'hello','world'}} for {'hello','world'}
