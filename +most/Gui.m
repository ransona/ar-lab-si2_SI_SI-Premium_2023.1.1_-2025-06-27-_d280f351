    ...
    methods (Access = protected)
        ...
        function initGuiOnce(obj)
            ...
            try
                ...
                % Recolor when initializing gui.
                hResourceStore = dabs.resources.ResourceStore();
                recolorGuiDevices = hResourceStore.filterByClass('dabs.generic.recolorGuis');
                if any(find(cellfun(@(device)isa(device,'dabs.generic.recolorGuis'),recolorGuiDevices)))
                    recolorGuiDevice = recolorGuiDevices{1};
                    recolorGuiDevice.colorGuis();
                end
