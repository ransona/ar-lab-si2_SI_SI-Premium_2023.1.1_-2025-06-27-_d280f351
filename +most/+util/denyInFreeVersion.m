...
if isempty(functionDescription)
    message = 'This functionality is not available in the basic version of ScanImage';
else
    message = sprintf('%s is not available in the basic version of ScanImage',functionDescription);
end
