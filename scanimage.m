function [hSI_,hSICtl_] = scanimage(mdf,usr,varargin)
    ...
    if ~verLessThan('MATLAB','9.8')
        set(groot,'defaultAxesToolbarVisible','off'); %Hides axes toolbars. 
        % Mathworks should make toggling the toolbar visibility a less expensive 
        % call before considering removing this.
    end
